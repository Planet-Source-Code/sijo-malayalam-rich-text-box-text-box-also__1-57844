...
Private Sub MnuInsertName_Click()
    mlm.Text = mlm.Text & " " & "ÿﬂÊºﬁ ÁÿﬁÀÌøÌ Œ‹œﬁ{¢"
End Sub

Private Sub MnuOffer_Click()
mlm.Text = "Œ‹œﬁ{ﬂµZAÌ ßÏ µYÁdøﬁZ ßÁMﬁZ ÿÏº»cŒﬁœﬂ" & vbCrLf & _
"‹ÕﬂA·Kƒﬁ√Ìµ‚ø·ƒW ’ﬂ’¯πZAÌ" & vbCrLf & "ÿﬂÁºﬁ.ÆGÌ Êµ.Áµﬁ¢ ÿwV÷ﬂA·µ" & vbCrLf
End Sub
